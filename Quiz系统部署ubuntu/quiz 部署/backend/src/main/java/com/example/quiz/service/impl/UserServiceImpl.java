...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public Result updateUser(Long id, String userName, String password) {
        if (id == null) {
        ...
        // 检查用户名是否被其他用户占用
        if (StringUtils.isNotBlank(userName) && !userName.equals(existUser.getUserName())) {
            User userWithSameName = userMapper.findByUsername(userName);
